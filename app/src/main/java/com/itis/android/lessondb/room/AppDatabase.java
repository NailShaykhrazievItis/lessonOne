...
import com.itis.android.lessondb.room.dao.PublishDao;
 ...
 */
@Database(entities = {RoomBook.class, RoomAuthor.class, RoomPublishing.class}, version = 1)
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public abstract PublishDao getPublishDao();
